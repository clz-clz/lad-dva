...
METHOD_LABEL = {
    ...
    "lad_rg_no_lads":            r"LAD-RG $-$LADS",
    "lad_rg_no_ror":             r"LAD-RG $-$RoR",
    "lad_rg_no_gasd":            r"LAD-RG $-$GASD",
    "lad_rg_lads_ror":           r"LAD-RG (LADS+RoR)",
    "lad_rg_lads_gasd":          r"LAD-RG (LADS+GASD)",
    "lad_rg_ror_gasd":           r"LAD-RG (RoR+GASD)",
    "lad_rg_coder_only":         r"LAD-RG (Coder only)",
